...
class Item:
    ...
    def update_llm_evaluation_results(self, metric_name: str, metric_result: str) -> None:
        if "llm_evaluation_results" not in self.output:
            self.output["llm_evaluation_results"] = {}
        self.output["llm_evaluation_results"][metric_name] = metric_result
